...
public final class Content {
    ...
    public static final String locationIp = "127.0.0.1";//以太网ip
    ...
    public static MqttWebSocketServer mqttServer = null;
    ...
    public static final String dbSplit = "q30,1g,9k,6vhsnw";//临时地图
    /**
     * robotState：
     * 0:关机
     * 1:静止
    ...
    public static final String ADDPOINTPOSITION = "addPointPosition";//返回点数据
    ...
    public static final String GET_TASK_STATE = "get_task_state";//当前地图的任务
    public static final String GET_ALL_TASK_STATE = "get_all_task_state";//所有地图的任务
    ...
    public static int chargingGpioCount = 0;
    ...
    public static final String EMERGENCY_STOP = "emergency_stop";//急停按键
    ...
    public static final String ROBOT_TASK_DATE = "robot_task_date";//机器人历史任务时间
    ...
    public static final String dbTaskPointState = "dbTaskPointState";
    ...
    public static String update_file_name = "";//升级文件的大小
    ...
    public static final String ERROR_MSG = "error_msg";//点任务报错信息
    public static final String ROS_BAG = "ros_bag";//点任务报错信息
    public static final String ROBOT_TASK_ERROR = "robot_task_error";//点任务报错信息
    public static final String REPORT_TIME = "report_time";//点任务报错信息
    public static final String GET_BAG = "get_bag";
