package com.retron.robot.uvclamp;
        ...
        public void run() {
            ...
            try {
                ...
                if (len > 0) {
                    ...
                    Log.d(TAG, "读取数据 ： " + editText.getText().toString() + " ,two : " + editText.getText().toString().substring(12, 16));
                    openBattery = 0;
                    EventBus.getDefault().post(new EventBusMessage(BaseEvent.BATTERY_DATA, data));
                    String msg = "放电";
