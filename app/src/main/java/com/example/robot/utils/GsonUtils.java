...
public class GsonUtils {
    ...
    private ArrayList<RobotPointPositions> mRobotPositions = null;
...
//    public void setmRobotPositions(ArrayList<RobotPointPositions> robotPositions) {
//        this.mRobotPositions = robotPositions;
//    }
...
//    }
    ...
    public String sendFileCount(String type) {
        jsonObject = new JSONObject();
        try {
            jsonObject.put(TYPE, type);
            jsonObject.put(Content.FileCount, Content.randomFileCount);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        Log.d("sendFileCount ", jsonObject.toString());
...
//    public String putBattery(String type, String status) {
//        jsonObject = new JSONObject();
//        try {
//            jsonObject.put(TYPE, type);
...
//    }
    ...
    public String putMapListMessage(String type, RobotMap robotMap) {
        ...
        Log.d("putMapListMessage ", jsonObject.toString());
        return jsonObject.toString();
    }
    ...
    public String sendRobotMsg(String type, int msg) {
        jsonObject = new JSONObject();
        try {
            jsonObject.put(TYPE, type);
            jsonObject.put(type, msg);
    ...
    public String sendEditTaskMsg(String type, List<String> list, List<TaskBean> taskBeans) {
        jsonObject = new JSONObject();
        try {
            jsonObject.put(TYPE, type);
            ...
            if (taskBeans != null) {
                for (int i = 0; i < taskBeans.size(); i++) {
                    ...
                    edJson.put(Content.POINT_NAME, taskBeans.get(i).getName());
                    edJson.put(Content.POINT_TIME, taskBeans.get(i).getDisinfectTime());
                    edJson.put(Content.POINT_X, taskBeans.get(i).getX());
                    edJson.put(Content.POINT_Y, taskBeans.get(i).getY());
        ...
        Log.d("sendEditTaskMsg ", jsonObject.toString());
        return jsonObject.toString();
    }

    public String sendRobotMsg(String type, ArrayList<RobotPointPositions> robotPointPositions, RobotMap robotMap) {
            ...
            if (robotMap != null) {
                for (int i = 0; i < robotMap.getData().size(); i++) {
                    ...
                    if (robotPointPositions.size() != 0) {
                        if (robotMap.getData().get(i).getName().equals(robotPointPositions.get(i).getMapName())) {
                            for (int j = 0; j < robotPointPositions.size(); j++) {
                                JSONObject pointObject = new JSONObject();
                                pointObject.put(Content.POINT_NAME, robotPointPositions.get(i).getName());
                                pointObject.put(Content.POINT_X, robotPointPositions.get(i).getGridX());
                                pointObject.put(Content.POINT_Y, robotPointPositions.get(i).getGridY());
                                pointObject.put(Content.ANGLE, robotPointPositions.get(i).getAngle());
                                pointObject.put(Content.POINT_TYPE, robotPointPositions.get(i).getType());
                                pointObject.put(Content.POINT_TIME, robotPointPositions.get(i).getPointTime());
                                mRobotPositionsArray.put(i, pointObject);
                            }
                        }
                    }
    ...
    public String sendRobotWorkingCount(String type) {
        jsonObject = new JSONObject();
        try {
            jsonObject.put(TYPE, type);
...
//            jsonObject.put(Content.WORLD_ULTRASONIC, mWorldUltrasonicArray);
//            JSONArray mRobotPositionsArray = new JSONArray();
//            if (mRobotPositions.size() != 0) {
//                for (int i = 0; i < mRobotPositions.size(); i++) {
//                    JSONObject object = new JSONObject();
//                    object.put(Content.POINT_NAME, mRobotPositions.get(i).getName());
//                    object.put(Content.POINT_X, mRobotPositions.get(i).getGridX());
//                    object.put(Content.POINT_Y, mRobotPositions.get(i).getGridY());
//                    object.put(Content.ANGLE, mRobotPositions.get(i).getAngle());
//                    object.put(Content.POINT_TYPE, mRobotPositions.get(i).getType());
//                    object.put(Content.POINT_TIME, mRobotPositions.get(i).getPointTime());
