...
public class TaskSqLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + Content.tableName + "(_id integer primary key autoincrement, " + Content.dbTaskMapName + " varchar(200), " + Content.dbTaskName + " varchar(200), " + Content.dbTime + " varchar(200)," + Content.dbData + " varchar(200)," + Content.dbStartBattery +" varchar(50)," + Content.dbEndBattery + " varchar(50)," + Content.dbTaskIndex + " varchar(50))");
